    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Let's take a look at the two expressions below:
            The first expression identifies a integer variable, age, and assigns a value, 2, to it.
            The second expression invokes the WriteLine method, which prints a message that contains 
            variables {dog} and {age} in the console window.
            */
            ...
            The int initializes b as an integer variable, in order for it to be used. 
